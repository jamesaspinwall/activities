...
class SnipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snip" do
    assert_difference('Snip.count') do
      post snips_url, params: { snip: { code: @snip.code, context: @snip.context, data: @snip.data, title: @snip.title, url: @snip.url } }
    end
  ...
  test "should update snip" do
    patch snip_url(@snip), params: { snip: { code: @snip.code, context: @snip.context, data: @snip.data, title: @snip.title, url: @snip.url } }
